...
{
	/// <summary>
	/// Represents an immutable 2D axis aligned bounding box. 
	/// </summary>
	public interface IImmutableBox2D : IEquatable<IImmutableBox2D>
	{
		/// <summary>
		...
		bool Contains(IImmutableBox2D rectangle);
		/// <summary>
		...
		bool Intersects(IImmutableBox2D rectangle);
